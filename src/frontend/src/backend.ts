...
import type { TeamSignup as _TeamSignup, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addMerchItem(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMerchItem(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMerchItems(): Promise<Array<MerchItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMerchItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSignups(): Promise<Array<TeamSignup>> {
        if (this.processError) {
            try {
    ...
    async getTeamSignup(): Promise<TeamSignup | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTeamSignup();
    ...
    async submitTeamSignup(arg0: TeamSignup): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitTeamSignup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_TeamSignup]): TeamSignup | null {
    return value.length === 0 ? null : value[0];
}
